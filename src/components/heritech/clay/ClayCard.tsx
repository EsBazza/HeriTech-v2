    ...
    >
      ...
      >
        ...
        <div className="absolute inset-x-2 top-2 flex items-start justify-between gap-1">
          <span className="text-[11px] px-2 py-1 bg-white/90 backdrop-blur-sm shadow-sm rounded-md font-medium text-slate-700 truncate max-w-[45%]">
            {flag} {product.country}
          </span>
          <span className="text-[11px] px-2 py-1 bg-emerald-50/90 backdrop-blur-sm shadow-sm rounded-md font-medium text-emerald-700 shrink-0">
        ...
        <div className="flex flex-col items-center gap-2">
          <div className="w-10 h-10 rounded-full bg-white/90 backdrop-blur-sm flex items-center justify-center shadow-md border border-white/60">
            <span className="text-xl select-none">
              {emoji}
            </span>
          </div>
          <span className="text-[11px] px-2 py-0.5 bg-blue-50/90 backdrop-blur-sm shadow-sm rounded-md font-medium text-blue-700">
            {product.stock} left
          </span>
        </div>
      </div>
      ...
      <div className="product-card-content p-4 space-y-3">
        ...
        <div className="flex items-end justify-between pt-3 border-t border-slate-100 gap-2">
          <div className="shrink-0">
            <p className="text-[10px] font-medium text-slate-500 mb-0.5">Price</p>
            <p className="text-base font-bold text-blue-600">${product.price}</p>
          </div>
          <div className="min-w-0 text-right">
            <p className="text-[10px] font-medium text-slate-500 mb-0.5">Artisan</p>
            <p className="text-[11px] font-semibold text-slate-800 truncate leading-tight" title={product.artisanName}>
              {product.artisanName}
            </p>
          </div>
        </div>
